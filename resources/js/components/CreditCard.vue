                        ...
                        <div class="card-item__wrapper">
                            ...
                            <label  class="card-item__number" ref="cardNumber">
                                     ...
                                     <!--<span v-for="(n, $index) in amexCardMask" :key="$index">-->
                                      <!--<transition name="slide-fade-up">-->
                                        <!--<div-->
                                                ...
                                                <!--v-if="$index > 4 && $index < 14 && amexCardMask.length > $index && n.trim() !== ''"-->
                                        <!--&gt;*</div>-->
                                        <!--<div class="card-item__numberItem"-->
                                             <!--:class="{ '-active' : n.trim() === '' }"-->
                                             <!--:key="$index" v-else-if="amexCardMask.length > $index">-->
                                          <!--{{amexCardMask[$index]}}-->
                                        <!--</div>-->
                                        <!--<div-->
                                                <!--class="card-item__numberItem"-->
                                ...
                                <template>
                                    ...
                                    <!--<transition name="slide-fade-up">-->
                                        <!--<span  v-bind:key="otherCardMask">{{otherCardMask}}</span>-->
                                    <!--</transition>-->


                                    <!--<div class="d-flex">-->
                                        <!--<article v-for="(n, $index) in otherCardMask" :key="$index">-->
                                                <!--<span>-->
                                                    <!--<span v-if="$index === 0">-->
                                                        <!--<transition name="slide-fade-up" >-->
                                                            <!--<span :key="$index">-->
                                                        ...
                                                        <!--</transition>-->
                                                    <!--</span>-->
                                                    <!--<span :key="$index" class="mr-2" v-else-if="$index === 3 || $index === 7 || $index === 11">-->
                                                        <!--{{ n }}-->
                                                    <!--</span>-->
                                    ...
                                    <label ref="cardName">
                                        <transition name="slide-fade-up">
                                            <div style="font-size: 110%" class="card-item__name" v-if="otherCardMask.length" key="1">
                                                <transition-group name="slide-fade-up">
                                                <span class="card-item__nameItem"
                                                      v-for="(n, $index) in otherCardMask.replace(/\s\s+/g, ' ')"
                                                      v-bind:key="$index + 1"
                                                >
                                                    {{n}}
                                                </span>
                                            ...
                                            <div style="font-size: 110%"  class="card-item__name" v-else key="2">#### #### #### ####</div>
                                        </transition>
                                    </label>
                                          ...
                                          <!--<span v-for="(n, $index) in otherCardMask" :key="$index">-->
                                            <!--<transition name="slide-fade-up">-->
                                              <!--<div-->
                                                      <!--class="card-item__numberItem"-->
                                                      <!--v-if="$index > 4 && $index < 15 && otherCardMask.length > $index && n.trim() !== ''"-->
                                              <!--&gt;*</div>-->
                                              <!--<div class="card-item__numberItem"-->
                                                   <!--:class="{ '-active' : n.trim() === '' }"-->
                                                   <!--:key="$index" v-else-if="otherCardMask.length > $index">-->
                                                <!--{{otherCardMask[$index]}}-->
                                              <!--</div>-->
                                              <!--<div-->
                                                      <!--class="card-item__numberItem"-->
